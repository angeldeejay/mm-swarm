...
sed -i -E "s|\"MMPM_MAGICMIRROR_URI\": (.*)|\"MMPM_MAGICMIRROR_URI\": \"http://$LOCAL_IP:$MM_PORT\",|g" /home/node/.config/mmpm/mmpm-env.json
...
for f in $(sudo ls -1 /var/www/mmpm/static/main-*); do
  ...
  sudo sed -i -E "s:(localhost|127.0.0.1):$LOCAL_IP:ig" "${f}"
done
